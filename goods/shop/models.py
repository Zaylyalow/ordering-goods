...
class Product(models.Model):
    ...
    price = models.DecimalField(max_digits=10, decimal_places=2, verbose_name='Цена за еденицу')
    ...
    size_eu = models.CharField(max_length=10, choices=SIZES_eu, blank=True, null=True, verbose_name='Размер_eu')
    # size_ru = models.IntegerField(max_length=3, choices=SIZES_ru, blank=True, null=True, verbose_name='Размер')
    unit = models.CharField(max_length=10, choices=UNIT, blank=True, null=True, verbose_name='Ед. изм')
